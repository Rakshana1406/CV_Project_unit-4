...
if uploaded_file is not None:
    ...
    # Convert uploaded image to OpenCV format (RGB → BGR)
    ...
    with col2:
        ...
        # Convert grayscale Canny edges to 3 channels for display
    ...
    # Download button
    _, buffer = cv2.imencode(".png", cartoon if style != "Pencil Sketch" else display_img)
    st.download_button(
